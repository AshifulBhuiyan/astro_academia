...
export const projects = [
...

  {
    ...
    description:
      "Computational study of test-particle and photon geodesics in Schwarzschild spacetime, focusing on long-time numerical behavior and structure preservation. Derived geodesic equations from the Schwarzschild metric and implemented multiple time integration schemes, including Runge-Kutta and symplectic methods. Compared orbital dynamics, energy conservation, and perihelion precession, highlighting the importance of geometric integrators for stable relativistic simulations.",
    link: "https://github.com/AshifulBhuiyan/NumericalGravity",
  },
